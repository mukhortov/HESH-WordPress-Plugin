...
a.registerHelper("hintWords","css",x),a.defineMIME("text/css",{documentTypes:e,mediaTypes:g,mediaFeatures:i,mediaValueKeywords:k,propertyKeywords:m,nonStandardPropertyKeywords:o,fontProperties:q,counterDescriptors:s,colorKeywords:u,valueKeywords:w,tokenHooks:{"/":function(a,b){return a.eat("*")?(b.tokenize=c,c(a,b)):!1}},name:"css"}),a.defineMIME("text/x-scss",{mediaTypes:g,mediaFeatures:i,mediaValueKeywords:k,propertyKeywords:m,nonStandardPropertyKeywords:o,colorKeywords:u,valueKeywords:w,fontProperties:q,allowNested:!0,tokenHooks:{"/":function(a,b){return a.eat("/")?(a.skipToEnd(),["comment","comment"]):a.eat("*")?(b.tokenize=c,c(a,b)):["operator","operator"]},":":function(a){return a.match(/\s*\{/)?[null,"{"]:!1},$:function(a){return a.match(/^[\w-]+/),a.match(/^\s*:/,!1)?["variable-2","variable-definition"]:["variable-2","variable"]},"#":function(a){return a.eat("{")?[null,"interpolation"]:!1}},name:"css",helperType:"scss"}),a.defineMIME("text/x-less",{mediaTypes:g,mediaFeatures:i,mediaValueKeywords:k,propertyKeywords:m,nonStandardPropertyKeywords:o,colorKeywords:u,valueKeywords:w,fontProperties:q,allowNested:!0,tokenHooks:{"/":function(a,b){return a.eat("/")?(a.skipToEnd(),["comment","comment"]):a.eat("*")?(b.tokenize=c,c(a,b)):["operator","operator"]},"@":function(a){return a.eat("{")?[null,"interpolation"]:a.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/,!1)?!1:(a.eatWhile(/[\w\\\-]/),a.match(/^\s*:/,!1)?["variable-2","variable-definition"]:["variable-2","variable"])},"&":function(){return["atom","atom"]}},name:"css",helperType:"less"}),a.defineMIME("text/x-gss",{documentTypes:e,mediaTypes:g,mediaFeatures:i,propertyKeywords:m,nonStandardPropertyKeywords:o,fontProperties:q,counterDescriptors:s,colorKeywords:u,valueKeywords:w,supportsAtComponent:!0,tokenHooks:{"/":function(a,b){return a.eat("*")?(b.tokenize=c,c(a,b)):!1}},name:"css",helperType:"gss"})}),function(a){"object"==typeof exports&&"object"==typeof module?a(require("../../lib/codemirror"),require("../xml/xml"),require("../javascript/javascript"),require("../css/css")):"function"==typeof define&&define.amd?define(["../../lib/codemirror","../xml/xml","../javascript/javascript","../css/css"],a):a(CodeMirror)}(function(a){"use strict";function b(a,b,c){var d=a.current(),e=d.search(b);return e>-1?a.backUp(d.length-e):d.match(/<\/?$/)&&(a.backUp(d.length),a.match(b,!1)||a.match(d)),c}function c(a){var b=i[a];return b?b:i[a]=new RegExp("\\s+"+a+"\\s*=\\s*('|\")?([^'\"]+)('|\")?\\s*")}function d(a,b){var d=a.match(c(b));return d?d[2]:""}function e(a,b){return new RegExp((b?"^":"")+"</s*"+a+"s*>","i")}function f(a,b){for(var c in a)for(var d=b[c]||(b[c]=[]),e=a[c],f=e.length-1;f>=0;f--)d.unshift(e[f])}function g(a,b){for(var c=0;c<a.length;c++){var e=a[c];if(!e[0]||e[1].test(d(b,e[0])))return e[2]}}var h={script:[["lang",/(javascript|babel)/i,"javascript"],["type",/^(?:text|application)\/(?:x-)?(?:java|ecma)script$|^$/i,"javascript"],["type",/./,"text/plain"],[null,null,"javascript"]],style:[["lang",/^css$/i,"css"],["type",/^(text\/)?(x-)?(stylesheet|css)$/i,"css"],["type",/./,"text/plain"],[null,null,"css"]]},i={};a.defineMode("htmlmixed",function(c,d){function i(d,f){var h,l=j.token(d,f.htmlState),m=/\btag\b/.test(l);if(m&&!/[<>\s\/]/.test(d.current())&&(h=f.htmlState.tagName&&f.htmlState.tagName.toLowerCase())&&k.hasOwnProperty(h))f.inTag=h+" ";else if(f.inTag&&m&&/>$/.test(d.current())){var n=/^([\S]+) (.*)/.exec(f.inTag);f.inTag=null;var o=">"==d.current()&&g(k[n[1]],n[2]),p=a.getMode(c,o),q=e(n[1],!0),r=e(n[1],!1);f.token=function(a,c){return a.match(q,!1)?(c.token=i,c.localState=c.localMode=null,null):b(a,r,c.localMode.token(a,c.localState))},f.localMode=p,f.localState=a.startState(p,j.indent(f.htmlState,""))}else f.inTag&&(f.inTag+=d.current(),d.eol()&&(f.inTag+=" "));return l}var j=a.getMode(c,{name:"xml",htmlMode:!0,multilineTagIndentFactor:d.multilineTagIndentFactor,multilineTagIndentPastTag:d.multilineTagIndentPastTag}),k={},l=d&&d.tags,m=d&&d.scriptTypes;if(f(h,k),l&&f(l,k),m)for(var n=m.length-1;n>=0;n--)k.script.unshift(["type",m[n].matches,m[n].mode]);return{startState:function(){var a=j.startState();return{token:i,inTag:null,localMode:null,localState:null,htmlState:a}},copyState:function(b){var c;return b.localState&&(c=a.copyState(b.localMode,b.localState)),{token:b.token,inTag:b.inTag,localMode:b.localMode,localState:c,htmlState:a.copyState(j,b.htmlState)}},token:function(a,b){return b.token(a,b)},indent:function(b,c){return!b.localMode||/^\s*<\//.test(c)?j.indent(b.htmlState,c):b.localMode.indent?b.localMode.indent(b.localState,c):a.Pass},innerMode:function(a){return{state:a.localState||a.htmlState,mode:a.localMode||j}}}},"xml","javascript","css"),a.defineMIME("text/html","htmlmixed")}),function(a){"object"==typeof exports&&"object"==typeof module?a(require("../../lib/codemirror"),require("../xml/xml"),require("../javascript/javascript"),require("../css/css")):"function"==typeof define&&define.amd?define(["../../lib/codemirror","../xml/xml","../javascript/javascript","../css/css"],a):a(CodeMirror)}(function(a){"use strict";a.defineMode("wordpresspost",function(b,c){function d(a,b){b.isInShortcode=!0;var c=g.token(a,b.shortcodeState),d=null===b.shortcodeState.tagName;return d&&!/^\[/.test(a.current())&&(b.token=e),c}function e(b,c){c.isInShortcode=!1;var e=f.token(b,c.htmlmixedState),h=null===c.htmlmixedState.htmlState.tagName;if(h&&/\[/.test(b.current())&&!c.htmlmixedState.localState&&null===e){var i=b.current(),j=i.search(/\[/);b.backUp(i.length-j),null==c.shortcodeState&&(c.shortcodeState=a.startState(g,f.indent(c.htmlmixedState,""))),c.token=d}return e}var f=a.getMode(b,{name:"htmlmixed",multilineTagIndentFactor:c.multilineTagIndentFactor,multilineTagIndentPastTag:c.multilineTagIndentPastTag}),g=a.getMode(b,{name:"shortcode",multilineTagIndentFactor:c.multilineTagIndentFactor,multilineTagIndentPastTag:c.multilineTagIndentPastTag});return{startState:function(){var a=f.startState();return{token:e,isInShortcode:!1,shortcodeState:null,htmlmixedState:a}},copyState:function(b){var c;return b.shortcodeState&&(c=a.copyState(g,b.shortcodeState)),{token:b.token,shortcodeState:c,htmlmixedState:a.copyState(f,b.htmlmixedState)}},token:function(a,b){return b.token(a,b)},indent:function(b,c){return b.isInShortcode?f.indent(b.htmlmixedState,c):b.isInShortcode?a.Pass:g.indent(b.shortcodeState,c)},innerMode:function(a){return a.isInShortcode?{state:a.shortcodeState,mode:g}:{state:a.htmlmixedState,mode:f}}}},"htmlmixed","shortcode")}),function(a){"object"==typeof exports&&"object"==typeof module?a(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],a):a(CodeMirror)}(function(a){"use strict";var b={autoSelfClosers:{},implicitlyClosed:{},contextGrabbers:{},doNotIndent:{},allowUnquoted:!0,allowMissing:!0,caseFold:!0};a.defineMode("shortcode",function(c,d){function e(a,b){var c=a.next();return"["===c?(y=a.eat("/")?"closeTag":"openTag",b.tokenize=f,"tag bracket"):(a.eatWhile(/[^\[]/),null)}function f(a,b){var c=a.next();if("]"===c||"/"===c&&a.eat("]"))return b.tokenize=e,y="]"===c?"endTag":"selfcloseTag","tag bracket";if("="===c)return y="equals",null;if("["===c){b.tokenize=e,b.state=k,b.tagName=b.tagStart=null;var d=b.tokenize(a,b);return d?d+" tag error":"tag error"}return/[\'\"]/.test(c)?(b.tokenize=g(c),b.stringStartCol=a.column(),b.tokenize(a,b)):(a.match(/^[^\s\u00a0=\[\]\"\']*[^\s\u00a0=\[\]\"\'\/]/),"word")}function g(a){var b=function(b,c){for(;!b.eol();)if(b.next()===a){c.tokenize=f;break}return"string"};return b.isInAttribute=!0,b}function h(a,b,c){this.tagHistory=[b],a.context&&(this.tagHistory=this.tagHistory.concat(a.context.tagHistory)),this.prev=a.context,this.tagName=b,this.indent=a.indented,this.startOfLine=c,(u.doNotIndent.hasOwnProperty(b)||a.context&&a.context.noIndent)&&(this.noIndent=!0)}function i(a){a.context&&(a.context=a.context.prev)}function j(a,b){for(var c;;){if(!a.context)return;if(c=a.context.tagName,!u.contextGrabbers.hasOwnProperty(c)||!u.contextGrabbers[c].hasOwnProperty(b))return;i(a)}}function k(a,b,c){return"openTag"===a?(c.tagStart=b.column(),l):"closeTag"===a?m:k}function l(a,b,c){return"word"===a?(c.tagName=b.current(),z="tag",p):(z="error",l)}function m(a,b,c){if("word"===a){var d=b.current();if(c.tagName=d,c.context&&c.context.tagName!==d&&u.implicitlyClosed.hasOwnProperty(c.context.tagName)&&i(c),c.context&&c.context.tagName===d||u.matchClosing===!1)return z="tag",n;if(c.context&&c.context.tagHistory.indexOf(d)>0){for(var e=c.context.tagHistory.indexOf(d),f=0;e>f;f++)i(c);return z="tag",n}return z="tag error",o}return z="error",o}function n(a,b,c){return"endTag"!==a?(z="error",n):(c.tagName=null,i(c),k)}function o(a,b,c){return z="error",n(a,b,c)}function p(a,b,c){if("word"===a)return z="attribute",q;if("endTag"===a||"selfcloseTag"===a){var d=c.tagName,e=c.tagStart;return c.tagName=c.tagStart=null,"selfcloseTag"===a||u.autoSelfClosers.hasOwnProperty(d)?j(c,d):(j(c,d),c.context=new h(c,d,e===c.indented)),k}return z="error",p}function q(a,b,c){return"equals"===a?r:(u.allowMissing||(z="error"),p(a,b,c))}function r(a,b,c){return"string"===a?s:"word"===a&&u.allowUnquoted?(z="string",p):(z="error",p(a,b,c))}function s(a,b,c){return"string"===a?s:p(a,b,c)}var t=c.indentUnit,u={},v=b;for(var w in v)u[w]=v[w];for(var x in d)u[x]=d[x];var y,z;return e.isInText=!0,{startState:function(a){var b={tokenize:e,state:k,indented:a||0,tagName:null,tagStart:null,context:null};return null!=a&&(b.baseIndent=a),b},token:function(a,b){if(!b.tagName&&a.sol()&&(b.indented=a.indentation()),a.eatSpace())return null;y=null;var c=b.tokenize(a,b);return(c||y)&&"comment"!==c&&(z=null,b.state=b.state(y||c,a,b),z&&(c="error"===z?c+" error":z)),c},indent:function(b,c,d){var g=b.context;if(b.tokenize.isInAttribute)return b.tagStart===b.indented?b.stringStartCol+1:b.indented+t;if(g&&g.noIndent)return a.Pass;if(b.tokenize!==f&&b.tokenize!==e)return d?d.match(/^(\s*)/)[0].length:0;if(b.tagName)return u.multilineTagIndentPastTag!==!1?b.tagStart+b.tagName.length+2:b.tagStart+t*(u.multilineTagIndentFactor||1);var h=c&&/^\[(\/)?([\w_:\.-]*)/.exec(c);if(h&&h[1])for(;g;){if(g.tagName===h[2]){g=g.prev;break}if(!u.implicitlyClosed.hasOwnProperty(g.tagName))break;g=g.prev}else if(h)for(;g;){var i=u.contextGrabbers[g.tagName];if(!i||!i.hasOwnProperty(h[2]))break;g=g.prev}for(;g&&g.prev&&!g.startOfLine;)g=g.prev;return g?g.indent+t:b.baseIndent||0},skipAttribute:function(a){a.state===r&&(a.state=p)}}})});var CodeMirrorCSS=CodeMirrorCSS||{};CodeMirrorCSS.Themes=["3024-day","3024-night","abcdef","ambiance-mobile","ambiance","base16-dark","base16-light","bespin","blackboard","cobalt","colorforth","dracula","eclipse","elegant","erlang-dark","hopscotch","icecoder","isotope","lesser-dark","liquibyte","material","mbo","mdn-like","midnight","monokai","neat","neo","night","paraiso-dark","paraiso-light","pastel-on-dark","railscasts","rubyblue","seti","solarized","the-matrix","tomorrow-night-bright","tomorrow-night-eighties","ttcn","twilight","vibrant-ink","xq-dark","xq-light","yeti","zenburn"],function(a,b,c,d,e){function f(){var f=null,g=0,h=0,i=document.getElementById("content"),j=null!=document.getElementById("post_ID")?document.getElementById("post_ID").value:0,k=document.getElementById("content-html"),l=document.getElementById("content-tmce"),m=-1!==document.cookie.indexOf("editor%3Dtinymce"),n=null!=document.getElementById("content-tmce"),o=document.getElementById("ed_toolbar"),p=document.getElementById("wp-content-editor-container"),q="heshFullscreen",r=null!=document.getElementById("save-post")?document.getElementById("save-post"):document.getElementById("publish"),s={mode:"wordpresspost",tabMode:"indent",theme:"material",lineNumbers:!0,matchBrackets:!0,indentUnit:4,indentWithTabs:!0,enterMode:"keep",lineWrapping:!0,autofocus:!0,styleActiveLine:!0,electricChars:!1,extraKeys:{F11:function(){G()},Esc:function(){G()},"Ctrl-S":function(){r.click()},"Cmd-S":function(){r.click()}}},t=function(a){var b="; "+document.cookie,c=b.split("; "+a+"=");return 2===c.length?c.pop().split(";").shift():void 0},u=t("hesh_plugin_font_size")||"12";s.theme=t("hesh_plugin_theme")||"material";var v,w,x=function(){B(),f=a.fromTextArea(i,s),f.on("change",function(){f.save(),clearTimeout(w),w=setTimeout(A,3e3)}),f.on("cursorActivity",function(){var a=f.getCursor();document.cookie="hesh_plugin_pos="+j+","+a.line+","+a.ch});var b=(t("hesh_plugin_pos")||"0,0,0").split(",");j===b[0]&&f.setCursor(parseFloat(b[1]),parseFloat(b[2])),F(),L(),g=1,y(),window.addEventListener("resize",z),window.setTimeout(A,3e3)},y=function(){var a=document.querySelector(".CodeMirror");a.style.marginTop=o.clientHeight+"px"},z=function(){clearTimeout(v),v=setTimeout(y,250)},A=function(){null!==document.querySelector(".CodeMirror")&&(document.querySelector("textarea.wp-editor-area").style.height=document.querySelector(".CodeMirror").clientHeight+"px")},B=function(){if(!h){var a={more:["<!--more-->",""],comment:["<!-- "," -->"],code:["<code>","</code>"],li:["<li>","</li>"],ol:["<ol>","</ol>"],ul:["<ul>","</ul>"],img:['<img src="$" alt="','">',"Enter the URL of the image"],ins:["<ins>","</ins>"],del:["<del>","</del>"],link:['<a href="$">',"</a>","Enter the destination URL"],blockquote:["\r<blockquote>","</blockquote>\r"],h3:["<h3>","</h3>"],h2:["<h2>","</h2>"],h1:["<h1>","</h1>"],p:["<p>","</p>"],i:["<em>","</em>"],b:["<strong>","</strong>"]};for(var b in a){var c=a[b],d=c[2]?'data-prompt="'+c[2]+'"':"";o.insertAdjacentHTML("afterbegin",'<input type="button" id="cm_content_'+b+"\" data-start='"+c[0]+"' data-end='"+c[1]+"' "+d+' class="ed_button button cm_ed_button" value="'+b+'">'),document.getElementById("cm_content_"+b).onclick=C}I(),K(),H(),h=1}},C=function(){var a=f.getCursor("start"),b=this.getAttribute("data-start"),d=this.getAttribute("data-end"),e=this.getAttribute("data-prompt")||null,g=f.getSelection();"cm_content_link"===this.id&&c?(c.open(),document.getElementById("wp-link-submit").onclick=function(){var d=c.getAttrs();b='<a href="'+d.href+'" title="'+d.title+'" target="'+d.target+'">',f.replaceSelection(b+g+"</a>"),c.close(),f.setCursor(a.line,a.ch+b.length),f.focus()}):(e&&(b=b.replace("$",window.prompt(e,""))),f.replaceSelection(b+g+d),f.setCursor(a.line,a.ch+b.length),f.focus())},D=function(){g&&(e.switchto&&e.switchto(this),f.toTextArea(),k.onclick=E,g=0,window.removeEventListener("resize",z))},E=function(){g||(e.switchto&&e.switchto(this),window.setTimeout(x,300),l.onclick=D)},F=function(){var a=document.querySelector(".CodeMirror"),b=document.createElement("div"),c=document.getElementById("wp-content-wrap"),d=a.getBoundingClientRect().top,e=function(b){b=b||window.event;var c=(b.pageY||b.clientY+document.body.scrollTop+document.documentElement.scrollTop)-d;a.style.height=(c>10?c:10)+"px",window.getSelection().removeAllRanges()};b.className="content-resize-handle",c.appendChild(b),b.onmousedown=function(){document.onmousemove=e},document.onmouseup=function(){document.onmousemove=null}},G=function(){p.className=-1===p.className.indexOf(q)?p.className+" "+q:p.className.replace(q,"");var a=document.getElementById("cm_content_fullscreen");a.value="fullscreen"===a.value?"exit fullscreen":"fullscreen",f.focus(),y()},H=function(){o.insertAdjacentHTML("afterbegin",'<input type="button" id="cm_content_fullscreen" class="ed_button button" title="Toggle fullscreen mode" value="fullscreen">'),document.getElementById("cm_content_fullscreen").onclick=G},I=function(){var a='<select id="cm_select_theme" class="button" title="Change editor colour scheme">';for(var c in b.Themes){var d=b.Themes[c],e=d===s.theme?" selected ":"";a+='<option value="'+d+'"'+e+">"+d+"</option>"}a+="</select>",o.insertAdjacentHTML("afterbegin",a),document.getElementById("cm_select_theme").onchange=function(){var a=this.value;f.setOption("theme",a),document.cookie="hesh_plugin_theme="+a}},J=function(){var a=document.getElementById("hesh-style"),b=".CodeMirror {font-size: "+u+"px !important;}";a?a.innerHTML=b:document.getElementsByTagName("head")[0].insertAdjacentHTML("beforeend",'<style id="hesh-style">'+b+"</style>")},K=function(){o.insertAdjacentHTML("afterbegin",'<select id="cm_font_size" class="button"><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="16">16</option><option value="18">18</option><option value="20">20</option><option value="22">22</option></select>');var a=document.getElementById("cm_font_size");J(),a.value=u,a.onchange=function(){u=this.value,J(),f.toTextArea(),x(),f.focus(),document.cookie="hesh_plugin_font_size="+u}},L=function(){if(!window.send_to_editor_wp){var a=function(a){g&&"content"===d?(f.replaceSelection(a),f.save()):window.send_to_editor_wp(a)};window.send_to_editor_wp=a}};m&&n?k.onclick=E:(x(),n?l.onclick=D:document.body.className+=" visual-editor-is-disabled")}window.addEventListener?window.addEventListener("load",f,!1):window.attachEvent&&window.attachEvent("onload",f)}(CodeMirror,CodeMirrorCSS,wpLink,wpActiveEditor,switchEditors);